...
* only assert exact metric values in date-bounded tests ([f6878c9](https://github.com/GetStream/stream-chat-java/commit/f6878c9329be03d8ad8dcfcefa817cad0fd18022))
