...
public class SharedLocationTest extends BasicTest {
    ...
    void whenUpdatingLiveLocation_thenNoException() throws StreamException {
        ...
        SharedLocationRequest request = SharedLocationRequest.builder()
        ...
        SharedLocationResponse response = SharedLocation.updateLocation()
                .request(request)
                .request();
        ...
        ActiveLiveLocationsResponse locationsResponse = SharedLocation.getLocations()
                .request();
    ...
    void whenGettingEmptyLiveLocations_thenNoException() throws StreamException {
        ActiveLiveLocationsResponse response = SharedLocation.getLocations()
                .request();
