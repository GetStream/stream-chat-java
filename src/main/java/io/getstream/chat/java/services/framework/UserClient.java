 ...
 *
 * <p>This client wraps a base {@link Client} and automatically injects a user-specific
 * authentication token into all service calls. It's designed for scenarios where different users
 * need to make authenticated API calls without creating separate client instances per user.
 *
 * @see Client
 */
