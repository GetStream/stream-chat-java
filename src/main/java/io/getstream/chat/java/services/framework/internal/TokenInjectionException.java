...
/**
 * Thrown when user token injection into a request fails. This can happen if: - A service method
 * doesn't return retrofit2.Call<?> - Retrofit's internal structure changes and reflection fails
 */
