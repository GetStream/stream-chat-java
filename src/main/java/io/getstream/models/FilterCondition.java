...
public class FilterCondition {
  ...
  public static Map<String, Object> autocomplete(@NotNull String fieldName, @NotNull String inputString) {
    return Collections.singletonMap(fieldName, Collections.singletonMap("$autocomplete", inputString));
  }

  public static Map<String, Object> contains(@NotNull String fieldName, @NotNull String inputString) {
  ...
  public static Map<String, Object> greaterThan(@NotNull String fieldName, @NotNull Object fieldValue) {
    return Collections.singletonMap(fieldName, Collections.singletonMap("$gt", fieldValue));
  }

  public static Map<String, Object> greaterThanEquals(@NotNull String fieldName, @NotNull Object fieldValue) {
    return Collections.singletonMap(fieldName, Collections.singletonMap("$gte", fieldValue));
  }

  public static Map<String, Object> lessThan(@NotNull String fieldName, @NotNull Object fieldValue) {
    return Collections.singletonMap(fieldName, Collections.singletonMap("lt", fieldValue));
  }

  public static Map<String, Object> lessThanEquals(@NotNull String fieldName, @NotNull Object fieldValue) {
  ...
  public static Map<String, Object> in(@NotNull String fieldName, @NotNull Collection<Object> fieldValues) {
  ...
  public static Map<String, Object> nin(@NotNull String fieldName, @NotNull Collection<Object> fieldValues) {
  ...
  public static Map<String, Object> distinct(@NotNull String fieldName, @NotNull Collection<String> memberIds) {
  ...
  public static Map<String, Object> distinct(@NotNull String fieldName, @NotNull String... memberIds) {
