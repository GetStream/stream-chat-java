...
// Backend SDK
Message message = Message.get("message-id").request().getMessage();
...
> [!WARNING]
> Deleting a message does not delete its file attachments. See [deleting attachments](/chat/docs/java/file_uploads/#deleting-files-and-images/) for more information.
