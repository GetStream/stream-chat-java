...
webhookHook.setWebhookURL("https://example.com/webhooks/stream/messages");

App.update().eventHooks(Arrays.asList(webhookHook)).request();
```
...
> [!NOTE]
> For reliable event delivery, you can also configure [SQS](/chat/docs/java/sqs/) or [SNS](/chat/docs/java/sns/) instead of webhooks.
...
| [Before Message Send](/chat/docs/java/before_message_send_webhook/) | Allows you to modify or moderate message content before sending it to the chat for everyone to see |
| [Custom Commands](/chat/docs/java/custom_commands_webhook/)         | Reacts to custom /slash commands                                                                   |
...
For more information on configuring pending messages, please refer to the [Pending Messages](/chat/docs/java/pending_messages/) documentation.
