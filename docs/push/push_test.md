...
- Your app has push notifications configured for at least one provider [in your app settings](/chat/docs/java/app_setting_overview/)

- You have a user that has at least one [device](/chat/docs/java/#push_devices/) associated
