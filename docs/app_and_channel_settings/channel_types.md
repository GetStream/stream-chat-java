...
The five default channel types come with good default permission policies. You can find more information on how to manage permissions in the [Channel Types section](/chat/docs/java/chat_permission_policies/).
...
ChannelType.update("my-channel-type")
  .reactions(false)
...
Please note that applications have a hard limit of 50 channel types. If you need more than this please have a look at the [Multi-tenant & Teams](/chat/docs/java/multi_tenant_chat/) section.
