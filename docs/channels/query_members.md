...
// Query all members
FilterObject filterAll = NeutralFilterObject.INSTANCE;
```

> [!NOTE]
> Stream Chat does not run MongoDB on the backend, only a [subset](/chat/docs/java/#query_syntax/) of the query options are available.
