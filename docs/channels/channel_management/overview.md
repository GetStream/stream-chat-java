...
| ------------------------------------------------------- | ---------------------------------------------------- | ------------------ | ---------------------- |
| [Archiving](/chat/docs/java/archiving_channels/) | Mark a channel as archived for a specific user       | Per-user state     | No data loss           |
| [Pinning](/chat/docs/java/pinning_channels/)     | Mark a channel as pinned for a specific user         | Per-user state     | No data loss           |
| [Muting](/chat/docs/java/muting_channels/)       | Suppress notifications for a channel                 | Per-user state     | No data loss           |
| [Hiding](/chat/docs/java/hiding_channels/)       | Hide a channel from query results until new messages | Per-user state     | Optional history clear |
| [Disabling](/chat/docs/java/disabling_channels/) | Prevent all client-side access to a channel          | All users affected | No data loss           |
| [Freezing](/chat/docs/java/freezing_channels/)   | Prevent new messages and reactions                   | All users affected | No data loss           |
| [Truncating](/chat/docs/java/truncate_channel/)  | Remove messages from a channel                       | All users affected | Message data deleted   |
| [Deleting](/chat/docs/java/channel_delete/)      | Permanently remove a channel                         | All users affected | All data deleted       |
