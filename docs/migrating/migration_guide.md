...
**Step 3b: Prepare Import File.** The [import section](/chat/docs/java/import/) has the full details. First practice with a small import.
...
**Step 4: Final Import.** Next, [Import](/chat/docs/java/import/) all historical data.
...
2. Export chat data in Stream's [import format](/chat/docs/java/import/)
...
2. Review the [Importing Data](/chat/docs/java/import/) guide
