In addition to [rate limits](/chat/docs/java/rate_limits/), Stream enforces **API budgets** on expensive
...
API budgets and [rate limits](/chat/docs/java/rate_limits/) work together but measure different things:
