...
For more details on permissions, see [User Permissions](/chat/docs/java/chat_permission_policies/).
...
For more details, see [App Settings](/chat/docs/java/app_setting_overview/).
...
For more details, see [Slow Mode & Throttling](/chat/docs/java/slow_mode/).
