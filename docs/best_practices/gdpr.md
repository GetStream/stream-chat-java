...
GDPR gives EU citizens the right to request access to their information and the right to have access to this information in a portable format. Stream Chat covers this requirement with the [Export User](/chat/docs/java/exporting_channels/) method.
...
- [Deleting a batch of users](/chat/docs/java/update_users/#deleting-many-users/)

- [Deleting a batch of channels](/chat/docs/java/channel_delete/#deleting-many-channels/)
